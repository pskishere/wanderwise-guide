  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <form 
        ...
        className="pt-12 pb-20 max-w-4xl mx-auto"
      >
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 space-y-6">
            <Input
              ...
              className="text-lg border-0 border-b px-0 py-3 rounded-none focus-visible:ring-0 focus-visible:border-pink-500 placeholder:text-gray-400 transition-colors"
              maxLength={30}
            />
            ...
            <div className="space-y-3 pb-6">
              ...
              {showPreview ? (
                ...
                <Textarea
                  ...
                  className="min-h-[400px] text-base resize-none border-2 border-gray-100 p-4 focus-visible:ring-0 focus-visible:border-pink-100 placeholder:text-gray-400 rounded-lg transition-colors"
                />
              )}
            </div>
          </div>
