    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white pb-20">
      ...
      <div className="container mx-auto px-4 pt-20 max-w-7xl">
        ...
        <Tabs defaultValue="posts" className="w-full">
          <TabsList className="w-full h-10 bg-white/50 backdrop-blur-sm sticky top-16 z-10 p-0.5 gap-0.5 rounded-xl">
            <TabsTrigger 
              value="posts" 
              className="w-1/2 h-9 data-[state=active]:bg-pink-500 data-[state=active]:text-white rounded-lg transition-all duration-300 text-xs font-medium"
            >
              <div className="flex items-center gap-2">
