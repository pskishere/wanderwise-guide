    ...
    <nav className="bg-white border-b shadow-sm">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="fixed top-4 left-1/2 -translate-x-1/2 bg-white/80 backdrop-blur-sm px-6 py-2 rounded-full shadow-lg border border-gray-100 flex items-center gap-8">
            <Link 
              to="/" 
